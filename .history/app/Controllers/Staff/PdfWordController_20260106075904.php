...
class PdfWordController extends ProtectedController
{
    ...
    public function generateWordFromLetter($id)
    {
        ...
        // Isi surat keterangan usaha (dengan indentasi di awal paragraf)
        ...
        $section->addText($isiKeterangan, 
            ['size' => 11, 'name' => 'Arial'], 
            ['indentation' => ['firstLine' => 720], 'spaceAfter' => 120]); // Menambahkan indentasi firstLine

        // Penutup (dengan indentasi di awal paragraf)
        $penutup = 'Demikian Surat keterangan usaha ini diberikan untuk dipergunakan sebagaimana mestinya.';
        $section->addText($penutup, 
            ['size' => 11, 'name' => 'Arial'], 
            ['indentation' => ['firstLine' => 720], 'spaceAfter' => 360]); // Menambahkan indentasi firstLine
