...
<div class="card">
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="<?= base_url('/staff/projects') ?>" id="projectForm">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="deskripsi" id="deskripsiInput" rows="4" required maxlength="1850" placeholder="Tulis deskripsi project... (Maksimal 1850 karakter)"></textarea>
