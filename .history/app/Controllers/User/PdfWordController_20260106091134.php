...
class PdfWordController extends ProtectedController
{
    ...
    public function generateWord($id)
    {
        ...
        // Permohonan dengan 11 spasi dan justify
        $permohonan = '           Dengan ini mengajukan permohonan pembuatan Surat ' . $letter['tipe_surat'] . '.';
        $section->addText($permohonan, 
            ['size' => 11, 'name' => 'Arial'], 
            ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spaceAfter' => 120]);

        // Isi surat dengan 11 spasi dan justify
        $isiSurat = '           ' . $letter['isi_surat'];
        $section->addText($isiSurat, 
            ['size' => 11, 'name' => 'Arial'], 
            ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spaceAfter' => 120]);

        // Penutup dengan 11 spasi dan justify
    ...
    public function generatePDF($id)
    {
        ...
        // Paragraf dengan indentasi dan justify
        $permohonan = '           Dengan ini mengajukan permohonan pembuatan Surat ' . $letter['tipe_surat'] . '.';
        $pdf->MultiCell(0, 5, $permohonan, 0, 'J', false, 1, '', '', true, 0, false, true, 5, 'T');
        $pdf->Ln(2);

        $isiSurat = '           ' . $letter['isi_surat'];
        $pdf->MultiCell(0, 5, $isiSurat, 0, 'J', false, 1, '', '', true, 0, false, true, 5, 'T');
        $pdf->Ln(2);

        $penutup = '           Demikian surat permohonan ini saya sampaikan. Atas perhatian dan bantuan Bapak/Ibu, saya ucapkan terima kasih.';
        $pdf->MultiCell(0, 5, $penutup, 0, 'J', false, 1, '', '', true, 0, false, true, 5, 'T');
        $pdf->Ln(8);
    ...
    public function previewWord()
    {
        ...
        $permohonan = '           Dengan ini mengajukan permohonan pembuatan Surat ' . $tipeSurat . '.';
        $section->addText($permohonan, ['size' => 11, 'name' => 'Arial'], 
            ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spaceAfter' => 120]);

        $isiSuratText = '           ' . $isiSurat;
        $section->addText($isiSuratText, ['size' => 11, 'name' => 'Arial'], 
            ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spaceAfter' => 120]);

        $penutup = '           Demikian surat permohonan ini saya sampaikan. Atas perhatian dan bantuan Bapak/Ibu, saya ucapkan terima kasih.';
        $section->addText($penutup, ['size' => 11, 'name' => 'Arial'], 
            ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spaceAfter' => 360]);

        $section->addText('Padangloang, ' . $tanggalSekarang, ['size' => 11, 'name' => 'Arial'], 
            ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::END, 'spaceAfter' => 1400]);
        
        $section->addText($profile['nama_lengkap'] ?? '-', ['size' => 11, 'name' => 'Arial'], 
            ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::END]);
    ...
    public function previewPDF()
    {
        ...
        $isiSuratText = '           ' . $isiSurat;
        $pdf->MultiCell(0, 5, $isiSuratText, 0, 'J', false, 1, '', '', true, 0, false, true, 5, 'T');
        $pdf->Ln(2);
