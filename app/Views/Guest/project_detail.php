    ...
    <div class="container position-relative z-1">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-end mb-5">
            <div>
                 <div class="section-tag mb-2">
                    ...
                    <span class="text">Detail Project</span>
                </div>
                ...
                <div class="d-flex align-items-center gap-3 mt-4 mb-3 flex-wrap">
                    ...
                    ?>
                    <div class="badge <?= $statusClass ?> px-3 py-2 rounded-pill fw-semibold border text-uppercase">
                        <?= esc($item['status']) ?>
                    </div>

                    <div class="badge bg-primary px-3 py-2 rounded-pill fw-semibold border d-flex align-items-center gap-2" style="background: rgba(59, 130, 246, 0.2) !important; border-color: rgba(59, 130, 246, 0.3) !important; color: #60a5fa !important;">
                        <span>Anggaran:</span>
                        <span>Rp<?= number_format($item['anggaran'] ?? 0, 0, ',', '.') ?></span>
                    </div>
                </div>
            </div>
            <a href="<?= base_url('/project') ?>" class="btn-modern-outline mt-4 mt-md-0">
        ...
        <div class="news-content-card">
            <?php if ($item['thumbnail']): ?>
                <img src="<?= base_url($item['thumbnail']) ?>" class="news-thumbnail" alt="<?= esc($item['judul']) ?>">
            <?php else: ?>
                <div class="news-thumbnail d-flex align-items-center justify-content-center bg-light" style="height: 300px;"><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="#9ca3af" viewBox="0 0 16 16"><path d="M6.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/><path d="M2.002 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2zm12 1a1 1 0 0 1 1 1v6.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12V3a1 1 0 0 1 1-1z"/></svg></div>
            <?php endif; ?>
        ...
        <div class="mb-4">
            <h4 class="text-white fw-bold">Dokumentasi Project</h4>
            <p class="text-muted">Foto dan video progres pembangunan</p>
        </div>
        ...
        <div id="empty-state" class="col-12 text-center py-5" style="display: none;">
            <div class="empty-state-glass">
                <div class="icon">📷</div>
                <p>Belum ada dokumentasi untuk project ini.</p>
            </div>
        </div>
...
function loadMedia(page = 1) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            // Scroll to media section (optional, unlike berita, maybe we stay?)
