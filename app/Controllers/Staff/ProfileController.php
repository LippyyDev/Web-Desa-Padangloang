    ...
    public function update()
    {
        ...
        if ($file && $file->isValid()) {
            ...
            if (!in_array($extension, $allowedExtensions)) {
                return redirect()->to('/staff/profil')->with('error', 'Format file tidak diperbolehkan. Hanya JPG, JPEG, PNG, dan WEBP.');
            }

            if ($file->getSize() > 1048576) {
                return redirect()->to('/staff/profil')->with('error', 'Ukuran foto profil tidak boleh lebih dari 1 MB.');
            }
