...
class EmailService
{
    ...
    protected function getOtpRegisterTemplate(string $name, string $otp, string $verificationLink): string
    {
        ...
        <head>
            ...
            <style>
                ...
                .otp-box { background-color: white; border: 2px dashed #007bff; padding: 20px; text-align: center; margin: 20px 0; border-radius: 5px; }
                .otp-code { font-size: 32px; font-weight: bold; color: #007bff; letter-spacing: 5px; }
                .link-box { background-color: white; border: 2px solid #007bff; padding: 20px; text-align: center; margin: 20px 0; border-radius: 5px; }
                .verify-btn { display: inline-block; background-color: #007bff; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 10px 0; }
        ...
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <p>Terima kasih telah mendaftar di Website Padang Loang. Untuk menyelesaikan proses registrasi, silakan gunakan salah satu metode verifikasi berikut:</p>
                    ...
                    <div class='link-box'>
                        ...
                        <a href='{$verificationLink}' class='verify-btn'>Verifikasi Akun</a>
                    ...
                    <p style='margin-top: 20px;'><strong>Catatan:</strong> Kode OTP dan link verifikasi berlaku selama <strong>1 jam</strong>. Jangan bagikan kode atau link ini kepada siapa pun.</p>
                    <p>Jika Anda tidak melakukan registrasi, abaikan email ini.</p>
                </div>
                <div class='footer'>
                    <p>Email ini dikirim secara otomatis, mohon tidak membalas email ini.</p>
                    <p>&copy; " . date('Y') . " Website Padang Loang. All rights reserved.</p>
                </div>
            </div>
        </body>
        </html>";
    ...
    protected function getNotificationTemplate(string $name, string $title, string $message, string $type = 'info', string $actionUrl = null, string $letterTitle = null, string $letterType = null): string
    {
        ...
        $logoUrl = 'https://image2url.com/r2/bucket3/images/1767877217074-b28d4740-b35f-464b-bacc-ed74a092dd01.webp';
        ...
        <head>
            ...
            <style>
                ...
                .header-logo-wrapper { background-color: white; padding: 15px; border-radius: 8px; display: inline-block; margin-bottom: 15px; }
                .header-logo { max-width: 200px; width: auto; height: auto; display: block; }
                .content { background-color: #f8f9fa; padding: 30px; border-radius: 0 0 5px 5px; }
            ...
            <div class='container'>
                <div class='header'>
                    <div class='header-logo-wrapper'>
                        <img src='{$logoUrl}' alt='Logo Desa Padang Loang' class='header-logo' style='max-width: 200px; width: auto; height: auto; display: block; object-fit: contain;'>
                    </div>
                ...
                <div class='content'>
                    ...
                    <div class='message-box'>
                        <h3 style='margin-top: 0; color: {$color['bg']};'>{$title}</h3>
