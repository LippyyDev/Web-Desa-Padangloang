...
class PdfWordController extends ProtectedController
{
    ...
    /**
     * Helper function untuk mendapatkan data Kepala Desa dari perangkat desa
     */
    private function getKepalaDesaData()
    {
        $perangkatModel = new PerangkatDesaModel();
        $kepalaDesa = $perangkatModel->like('jabatan', 'Kepala Desa', 'both')->first();
        
        if ($kepalaDesa) {
            return [
                'nama' => $kepalaDesa['nama'] ?? 'Kepala Desa',
                'jabatan' => $kepalaDesa['jabatan'] ?? 'Kepala Desa'
            ];
        }
    ...
    /**
     * Helper function untuk mendapatkan alamat kantor dari desa profile
     */
    private function getOfficeAddress()
    {
        $desaProfileModel = new DesaProfileModel();
        $profile = $desaProfileModel->first();
        
        if ($profile && !empty($profile['alamat_kantor'])) {
            return $profile['alamat_kantor'];
        }
        
        return 'Desa Padangloang, Kecamatan Ujung Loe, Kabupaten Bulukumba';
    }
    ...
    public function generateWordFromLetter($id)
    {
        ...
        // Get Kepala Desa data and office address
        $kepalaDesaData = $this->getKepalaDesaData();
        ...
        if ($letter['tipe_surat'] === 'Keterangan Tidak Mampu') {
            ...
            $this->generateKeteranganTidakMampu($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $bulan, $kepalaDesaData, $officeAddress);
        } elseif ($letter['tipe_surat'] === 'Keterangan Belum Menikah') {
            // Format untuk Keterangan Belum Menikah
            $this->generateKeteranganBelumMenikah($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $kepalaDesaData, $officeAddress);
        } elseif ($letter['tipe_surat'] === 'Keterangan Domisili') {
            // Format untuk Keterangan Domisili
            $this->generateKeteranganDomisili($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $kepalaDesaData, $officeAddress);
        } elseif ($letter['tipe_surat'] === 'Undangan') {
            // Format untuk Undangan
            $this->generateUndangan($section, $tanggalSekarang);
        } else {
            // Format untuk Keterangan Usaha
            $this->generateKeteranganUsaha($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $kepalaDesaData, $officeAddress);
        }
     ...
     */
    private function generateKeteranganUsaha($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $kepalaDesaData, $officeAddress)
    {
        ...
        $cell3->addText($kepalaDesaData['nama'], ['size' => 11, 'name' => 'Arial'], ['spaceAfter' => 0]);
        ...
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial'], ['spaceAfter' => 0]);
        $cell3 = $staffTable->addCell(6000, $cellStyleNoBorder);
        $cell3->addText($kepalaDesaData['jabatan'], ['size' => 11, 'name' => 'Arial'], ['spaceAfter' => 0]);
        ...
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial'], ['spaceAfter' => 0]);
        $cell3 = $staffTable->addCell(6000, $cellStyleNoBorder);
        $cell3->addText($officeAddress, ['size' => 11, 'name' => 'Arial'], ['spaceAfter' => 0]);
        ...
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial'], ['spaceAfter' => 0]);
        $cell3 = $senderTable->addCell(6000, $cellStyleNoBorder);
        $cell3->addText($this->getProfileValue($senderProfile, 'jenis_kelamin'), ['size' => 11, 'name' => 'Arial'], ['spaceAfter' => 0]);
        ...
        // Nama penandatangan
        $section->addText($kepalaDesaData['nama'], 
            ['size' => 11, 'name' => 'Arial'], 
     ...
     */
    private function generateKeteranganTidakMampu($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $bulan, $kepalaDesaData, $officeAddress)
    {
        $cellStyleNoBorder = [
            'borderTopSize' => 0,
            'borderTopColor' => 'FFFFFF',
     ...
     */
    private function generateKeteranganBelumMenikah($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $kepalaDesaData, $officeAddress)
    {
        $cellStyleNoBorder = [
            'borderTopSize' => 0,
            'borderTopColor' => 'FFFFFF',
     ...
     */
    private function generateKeteranganDomisili($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang, $kepalaDesaData, $officeAddress)
    {
        $cellStyleNoBorder = [
            'borderTopSize' => 0,
            'borderTopColor' => 'FFFFFF',
...
private function generateUndangan($section, $tanggalSekarang)
{
    ...
    public function downloadTemplate($tipe)
    {
        ...
        if ($tipeSurat === 'Keterangan Tidak Mampu') {
            $this->generateKeteranganTidakMampu($section, $emptyProfile, $staffProfile, $tempatTanggalLahirKosong, $tanggalSekarang, $bulan, $kepalaDesaData, $officeAddress);
        } elseif ($tipeSurat === 'Keterangan Belum Menikah') {
            $this->generateKeteranganBelumMenikah($section, $emptyProfile, $staffProfile, $tempatTanggalLahirKosong, $tanggalSekarang, $kepalaDesaData, $officeAddress);
        } elseif ($tipeSurat === 'Keterangan Domisili') {
            $this->generateKeteranganDomisili($section, $emptyProfile, $staffProfile, $tempatTanggalLahirKosong, $tanggalSekarang, $kepalaDesaData, $officeAddress);
        } elseif ($tipeSurat === 'Undangan') {
            // Format untuk Undangan
            $this->generateUndangan($section, $tanggalSekarang);
        } else {
            // Format untuk Keterangan Usaha
            $this->generateKeteranganUsaha($section, $emptyProfile, $staffProfile, $tempatTanggalLahirKosong, $tanggalSekarang, $kepalaDesaData, $officeAddress);
        }
