...
class PdfWordController extends ProtectedController
{
    ...
    public function generateWordFromLetter($id)
    {
        ...
        $staffTable->addRow();
        $cell0 = $staffTable->addCell(700, $cellStyleNoBorder); // Cell kosong untuk indentasi (dikurangi)
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        $cell1 = $staffTable->addCell(3500, $cellStyleNoBorder);
        $cell1->addText('Nama', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $staffTable->addCell(300, $cellStyleNoBorder);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $staffTable->addCell(5000, $cellStyleNoBorder);
        ...
        $senderTable->addRow();
        $cell0 = $senderTable->addCell(1000, $cellStyleNoBorder); // Cell kosong untuk indentasi (diperbesar)
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        $cell1 = $senderTable->addCell(3500, $cellStyleNoBorder);
        $cell1->addText('Nama', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $senderTable->addCell(300, $cellStyleNoBorder);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $senderTable->addCell(5000, $cellStyleNoBorder);
        ...
        // Isi surat keterangan usaha (template dengan placeholder dan indentasi)
