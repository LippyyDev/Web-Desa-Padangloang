...
class EmailService
{
    ...
    protected function getOtpRegisterTemplate(string $name, string $otp, string $verificationLink): string
    {
        ...
        return "<!DOCTYPE html><html><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1.0'></head><body style='margin:0;padding:0;font-family:Arial,sans-serif;line-height:1.6;color:#333;background-color:#f4f4f4'><table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%' style='background-color:#f4f4f4'><tr><td align='center' style='padding:20px 0'><table role='presentation' cellspacing='0' cellpadding='0' border='0' width='600' style='max-width:600px;background-color:white;border-radius:5px;overflow:hidden'><tr><td style='background-color:#007bff;padding:0;text-align:center'><img src='{$headerImageUrl}' alt='Desa Padang Loang' width='600' style='width:100%;max-width:600px;height:auto;display:block;border:0;outline:none;text-decoration:none'></td></tr><tr><td style='background-color:#f8f9fa;padding:30px'><p style='margin:0 0 15px 0'>Halo <strong>{$nameEscaped}</strong>,</p><p style='margin:0 0 20px 0'>Terima kasih telah mendaftar di Website Padang Loang. Untuk menyelesaikan proses registrasi, silakan gunakan salah satu metode verifikasi berikut:</p><table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%' style='background-color:white;border:2px dashed #007bff;margin:20px 0'><tr><td style='padding:20px;text-align:center'><p style='margin:0 0 10px 0;font-weight:bold'>Kode OTP Anda:</p><div style='font-size:32px;font-weight:bold;color:#007bff;letter-spacing:5px;margin:10px 0'>{$otpEscaped}</div><p style='margin:10px 0 0 0;font-size:12px;color:#666'>Masukkan kode ini di halaman verifikasi</p></td></tr></table><p style='text-align:center;margin:20px 0;color:#666;font-weight:bold'>ATAU</p><table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%' style='background-color:white;border:2px solid #007bff;margin:20px 0'><tr><td style='padding:20px;text-align:center'><p style='margin:0 0 15px 0;font-weight:bold'>Klik tombol di bawah untuk verifikasi:</p><a href='{$linkEscaped}' style='display:inline-block;background-color:#007bff;color:white;padding:12px 30px;text-decoration:none;border-radius:5px;font-weight:bold;margin:10px 0'>Verifikasi Akun</a><p style='margin:15px 0 0 0;font-size:12px;color:#666'>Atau salin link berikut:<br><a href='{$linkEscaped}' style='color:#007bff;word-break:break-all'>{$linkEscaped}</a></p></td></tr></table><p style='margin:20px 0 15px 0'><strong>Catatan:</strong> Kode OTP dan link verifikasi berlaku selama <strong>1 jam</strong>. Jangan bagikan kode atau link ini kepada siapa pun.</p><p style='margin:0'>Jika Anda tidak melakukan registrasi, abaikan email ini.</p></td></tr><tr><td style='text-align:center;padding:20px;color:#666;font-size:12px;background-color:#f8f9fa'><p style='margin:0 0 5px 0'>Email ini dikirim secara otomatis, mohon tidak membalas email ini.</p><p style='margin:0'>&copy; " . date('Y') . " Website Padang Loang. All rights reserved.</p></td></tr></table></td></tr></table></body></html>";
    }
    ...
    protected function getOtpResetTemplate(string $name, string $otp): string
    {
        ...
        return "<!DOCTYPE html><html><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1.0'></head><body style='margin:0;padding:0;font-family:Arial,sans-serif;line-height:1.6;color:#333;background-color:#f4f4f4'><table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%' style='background-color:#f4f4f4'><tr><td align='center' style='padding:20px 0'><table role='presentation' cellspacing='0' cellpadding='0' border='0' width='600' style='max-width:600px;background-color:white;border-radius:5px;overflow:hidden'><tr><td style='background-color:#dc3545;padding:0;text-align:center'><img src='{$headerImageUrl}' alt='Desa Padang Loang' width='600' style='width:100%;max-width:600px;height:auto;display:block;border:0;outline:none;text-decoration:none'></td></tr><tr><td style='background-color:#f8f9fa;padding:30px'><p style='margin:0 0 15px 0'>Halo <strong>{$nameEscaped}</strong>,</p><p style='margin:0 0 20px 0'>Kami menerima permintaan untuk mereset password akun Anda. Gunakan kode OTP berikut untuk melanjutkan:</p><table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%' style='background-color:white;border:2px dashed #dc3545;margin:20px 0'><tr><td style='padding:20px;text-align:center'><div style='font-size:32px;font-weight:bold;color:#dc3545;letter-spacing:5px'>{$otpEscaped}</div></td></tr></table><p style='margin:20px 0 15px 0'>Kode OTP ini berlaku selama <strong>1 jam</strong>. Jangan bagikan kode ini kepada siapa pun.</p><p style='margin:0'>Jika Anda tidak meminta reset password, abaikan email ini dan password Anda tidak akan berubah.</p></td></tr><tr><td style='text-align:center;padding:20px;color:#666;font-size:12px;background-color:#f8f9fa'><p style='margin:0 0 5px 0'>Email ini dikirim secara otomatis, mohon tidak membalas email ini.</p><p style='margin:0'>&copy; " . date('Y') . " Website Padang Loang. All rights reserved.</p></td></tr></table></td></tr></table></body></html>";
    }
