...
private function generateUndangan($section, $tanggalSekarang)
{
    ...
    // Kepada - DIUBAH: Indentasi diperbesar dari 700 menjadi 1000
    $section->addText('Kepada', 
        ['size' => 11, 'name' => 'Arial'], 
        ['indentation' => ['left' => 1000], 'spaceAfter' => 120]);
    
    $section->addText('Yth.', 
        ['size' => 11, 'name' => 'Arial'], 
        ['indentation' => ['left' => 1000], 'spaceAfter' => 120]);

    // Daftar penerima - DIUBAH: Indentasi diperbesar dari 700 menjadi 1000
    $section->addText('1.         ( ISI DISINI)', 
        ['size' => 11, 'name' => 'Arial'], 
        ['indentation' => ['left' => 1000], 'spaceAfter' => 60]);
