...
class PdfWordController extends ProtectedController
{
    ...
    public function generateWordFromLetter($id)
    {
        ...
        // Cek tipe surat
        if ($letter['tipe_surat'] !== 'Keterangan Usaha' && $letter['tipe_surat'] !== 'Keterangan Tidak Mampu' && $letter['tipe_surat'] !== 'Keterangan Belum Menikah') {
            return redirect()->to('/staff/surat/' . $id)->with('error', 'Export hanya tersedia untuk Surat Keterangan Usaha, Keterangan Tidak Mampu, dan Keterangan Belum Menikah.');
        }
    ...
    private function generateKeteranganBelumMenikah($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang)
    {
        ...
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        $cell1 = $senderTable->addCell(2500, $cellStyleNoBorder);
        $cell1->addText('Tempat/Tgl Lahir', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $senderTable->addCell(300, $cellStyleNoBorder);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $senderTable->addCell(6000, $cellStyleNoBorder);
        ...
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        $cell1 = $senderTable->addCell(2500, $cellStyleNoBorder);
        $cell1->addText('Agama', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $senderTable->addCell(300, $cellStyleNoBorder);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $senderTable->addCell(6000, $cellStyleNoBorder);
        $cell3->addText($this->getProfileValue($senderProfile, 'agama'), ['size' => 11, 'name' => 'Arial']);
        
        $senderTable->addRow();
        $cell0 = $senderTable->addCell(700, $cellStyleNoBorder);
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        $cell1 = $senderTable->addCell(2500, $cellStyleNoBorder);
        $cell1->addText('Pekerjaan', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $senderTable->addCell(300, $cellStyleNoBorder);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $senderTable->addCell(6000, $cellStyleNoBorder);
        $cell3->addText($this->getProfileValue($senderProfile, 'pekerjaan'), ['size' => 11, 'name' => 'Arial']);
        ...
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        $cell1 = $ayahTable->addCell(2500, $cellStyleNoBorder);
        $cell1->addText('Nama Ayah', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $ayahTable->addCell(300, $cellStyleNoBorder);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $ayahTable->addCell(6000, $cellStyleNoBorder);
        $cell3->addText('( ISI DISINI)', ['size' => 11, 'name' => 'Arial']);
        ...
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        $cell1 = $ibuTable->addCell(2500, $cellStyleNoBorder);
        $cell1->addText('Nama Ibu', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $ibuTable->addCell(300, $cellStyleNoBorder);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $ibuTable->addCell(6000, $cellStyleNoBorder);
        $cell3->addText('( ISI DISINI)', ['size' => 11, 'name' => 'Arial']);
