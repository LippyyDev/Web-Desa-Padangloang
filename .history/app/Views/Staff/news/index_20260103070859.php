                ...
                if (response.data && response.data.length > 0) {
                    ...
                    response.data.forEach(function(item) {
                        ...
                        html += '<div class="col-md-6 col-lg-4 col-xl-3">' +
                            ...
                            '<a href="<?= base_url('/staff/berita/') ?>' + item.id + '/edit" class="btn btn-sm btn-outline-primary">Edit</a> ' +
                            '<a href="<?= base_url('/staff/berita/') ?>' + item.id + '/hapus" class="btn btn-sm btn-outline-danger" onclick="return confirm(\'Hapus berita ini?\')">Hapus</a>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>';
