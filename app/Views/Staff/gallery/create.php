...
<div class="page-header">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <div class="text-muted small mt-1">Isi detail album dan media.</div>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="<?= base_url('/staff/galeri') ?>" id="albumForm">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-md-4">
                    <label class="form-label">Nama Album <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="nama_album" id="namaAlbumInput" maxlength="100" required>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="deskripsi" id="deskripsiInput" rows="2" maxlength="500"></textarea>
                    <div class="d-flex justify-content-end mt-1">
