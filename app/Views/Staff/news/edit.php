...
<div class="card">
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="<?= base_url('/staff/berita/' . $item['id']) ?>" id="beritaForm">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label">Judul <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="judul" id="judulInput" maxlength="150" value="<?= esc($item['judul']) ?>" required>
            ...
            <?php foreach ($media as $m): ?>
                <div class="col-md-3">
                    <div class="border rounded p-2 text-center position-relative" style="overflow: visible;">
                        <a href="<?= base_url('/staff/berita/media/' . $m['id'] . '/hapus') ?>" class="btn btn-sm btn-danger position-absolute" style="top: 4px; right: 4px; z-index: 1000; width: 28px; height: 28px; padding: 0; line-height: 1; border-radius: 50%; display: flex; align-items: center; justify-content: center;">&times;</a>
