...
class PdfWordController extends ProtectedController
{
    public function generateWord($id)
    {
        ...
        // Logo cell (kiri)
        $logoCell = $headerRow->addCell(1500, ['valign' => 'center']);
        ...
        // Teks header (tengah)
        $textCell = $headerRow->addCell(7500, ['valign' => 'center']);
        ...
        $textCell->addText('Alamat : Jl. Poros Padangloang Kecamatan Ujung Loe Kabupaten Bulukumba', 
            ['size' => 9, 'name' => 'Arial', 'color' => 'FF0000', 'underline' => 'single'], 
        ...
        $dataTable->addRow();
        $cell1 = $dataTable->addCell(3500);
        $cell1->addText('Nama', ['size' => 11, 'name' => 'Arial']);
        $cell2 = $dataTable->addCell(300);
        $cell2->addText(':', ['size' => 11, 'name' => 'Arial']);
        $cell3 = $dataTable->addCell(5000);
    ...
    public function generatePDF($id)
    {
        ...
        // Header text - menggunakan positioning yang tepat
        $pdf->SetY(18);
        $pdf->SetFont('helvetica', 'B', 11);
        $pdf->Cell(0, 5, 'PEMERINTAH KABUPATEN BULUKUMBA', 0, 1, 'C');
        $pdf->Cell(0, 5, 'KECAMATAN UJUNGLOE', 0, 1, 'C');
        $pdf->Cell(0, 5, 'DESA PADANGLOANG', 0, 1, 'C');
        
        // Alamat dengan warna merah dan underline
        $pdf->SetFont('helvetica', 'U', 9);
        $pdf->SetTextColor(255, 0, 0);
        $pdf->Cell(0, 5, 'Alamat : Jl. Poros Padangloang Kecamatan Ujung Loe Kabupaten Bulukumba', 0, 1, 'C');
