...
private function generateUndangan($section, $tanggalSekarang)
{
    ...
    // Kepada - DIUBAH: Indentasi diperbesar dari 700 menjadi 2000
    $section->addText('Kepada', 
        ['size' => 11, 'name' => 'Arial'], 
        ['indentation' => ['left' => 2000], 'spaceAfter' => 120]);
    
    $section->addText('Yth.', 
        ['size' => 11, 'name' => 'Arial'], 
        ['indentation' => ['left' => 2000], 'spaceAfter' => 120]);

    // Daftar penerima - DIUBAH: Indentasi diperbesar dari 700 menjadi 2000
