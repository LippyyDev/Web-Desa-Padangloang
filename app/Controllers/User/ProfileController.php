...
class ProfileController extends ProtectedController
{
    ...
    public function update()
    {
        ...
        if (!$this->validate($validationRules, $validationMessages)) {
            ...
            return redirect()->to('/user/profil')->withInput()->with('error', $errors);
        }
        ...
        if ($file && $file->isValid()) {
            ...
            if ($imgError !== null) {
                return redirect()->to('/user/profil')->with('error', $imgError);
            }
            ...
            if (!$this->toWebp($tempPath, $uploadPath . '/' . $webpName, $ext)) {
