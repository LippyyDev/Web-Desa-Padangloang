...
/**
    ...
    private function generateKeteranganBelumMenikah($section, $senderProfile, $staffProfile, $tempatTanggalLahirSender, $tanggalSekarang)
    {
        ...
        // Data staff yang menerangkan - cellMargin 0
        $staffTable = $section->addTable([
            'borderSize' => 0,
            'cellMargin' => 0,
        ]);
        ...
        // Data pengirim yang diterangkan - cellMargin 0
        $senderTable = $section->addTable([
            'borderSize' => 0,
            'cellMargin' => 0,
        ]);
        ...
        // TAMBAHKAN GAP DISINI setelah tabel terakhir
        $section->addTextBreak(1);

        // Isi surat - TANPA 11 spasi, TANPA justify
        ...
        // Penutup - TANPA 11 spasi, TANPA justify
