                    ...
                    <div class="letter-card">
                        ...
                        <div class="letter-card-body">
                            ...
                            <div class="letter-card-actions">
                                ...
                                <a href="<?= base_url('/staff/surat/') ?>${letter.id}/hapus" class="btn btn-sm btn-outline-danger">
            ...
            { 
                ...
                render: function(data) {
                    return '<div class="btn-group" role="group">' +
                        ...
                        '<a href="<?= base_url('/staff/surat/') ?>' + data + '/hapus" class="btn btn-sm btn-outline-danger">' +
