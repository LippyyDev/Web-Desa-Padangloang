...
class PdfWordController extends ProtectedController
{
    ...
    public function generateWordFromLetter($id)
    {
        ...
        $senderTable->addRow();
        $cell0 = $senderTable->addCell(700, $cellStyleNoBorder); // Cell kosong untuk indentasi (dikurangi)
        $cell0->addText('', ['size' => 11, 'name' => 'Arial']);
        ...
        $section->addText($isiKeterangan, 
            ['size' => 11, 'name' => 'Arial'], 
            ['indentation' => ['firstLine' => 1500], 'spaceAfter' => 120]);
        ...
        $section->addText($penutup, 
            ['size' => 11, 'name' => 'Arial'], 
            ['indentation' => ['firstLine' => 1500], 'spaceAfter' => 360]);
