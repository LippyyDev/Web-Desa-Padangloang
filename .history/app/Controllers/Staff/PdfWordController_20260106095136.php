...
class PdfWordController extends ProtectedController
{
    ...
    public function generateWordFromLetter($id)
    {
        ...
        // Cek tipe surat
        if ($letter['tipe_surat'] !== 'Keterangan Usaha' && $letter['tipe_surat'] !== 'Keterangan Tidak Mampu' && $letter['tipe_surat'] !== 'Keterangan Belum Menikah' && $letter['tipe_surat'] !== 'Keterangan Domisili') {
            return redirect()->to('/staff/surat/' . $id)->with('error', 'Export hanya tersedia untuk Surat Keterangan Usaha, Keterangan Tidak Mampu, Keterangan Belum Menikah, dan Keterangan Domisili.');
        }
