...
<div class="page-header">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <div class="text-muted small mt-1">Kelola data perangkat desa.</div>
        </div>
    </div>
...
<div class="mb-4">
    <div class="perangkat-search-container">
...
$(document).ready(function() {
                ...
                if (response.data && response.data.length > 0) {
                    ...
                    response.data.forEach(function(item) {
                        html += '<div class="col-md-6 col-lg-4 col-xl-3">' +
                            ...
                            '<a href="<?= base_url('/staff/perangkat-desa/') ?>' + item.id + '/hapus" class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i> Hapus</a>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>';
    ...
    function performSearch() {
        ...
        if (search) {
            ...
            $('#clearSearchBtn').hide();
            $('.perangkat-search-container .input-group').removeClass('has-clear-btn');
        }
    }
