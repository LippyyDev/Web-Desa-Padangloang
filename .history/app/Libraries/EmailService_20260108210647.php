...
class EmailService
{
    ...
    protected function getNotificationTemplate(string $name, string $title, string $message, string $type = 'info', string $actionUrl = null, string $letterTitle = null, string $letterType = null): string
    {
        ...
        <body>
            <div class='container'>
                <div class='header'>
                    <img src='{$logoUrl}' alt='Logo Desa Padang Loang' class='header-logo' style='max-width: 150px; height: auto; margin-bottom: 15px; display: block; margin-left: auto; margin-right: auto;'>
